...
showModal();
  ...
  jquery__WEBPACK_IMPORTED_MODULE_1___default()("a[href^='#']").on('click',function () {
		const _href = jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).attr("href");
		jquery__WEBPACK_IMPORTED_MODULE_1___default()("html, body").animate({ scrollTop: jquery__WEBPACK_IMPORTED_MODULE_1___default()(_href).offset().top + "px" });
		return false;
  });
// validation

function validateForm(form) {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(form).validate({
        rules: {
            name: {
                required: true,
                minlength: 2
        ...
        messages: {
            name: {
                ...
                minlength: jquery_validation__WEBPACK_IMPORTED_MODULE_2___default().validator.format("Повинно бути не меньш {0} символів!")
            },
...
const im = new (inputmask__WEBPACK_IMPORTED_MODULE_3___default())("+ 3 (999) 99-99-999");
...
jquery__WEBPACK_IMPORTED_MODULE_1___default()('form').on('submit',function (e) {
	...
	if (!jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).valid()) {
		return;
	}
	...
	jquery__WEBPACK_IMPORTED_MODULE_1___default().ajax({
		...
		jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).finf("input").val("");
		jquery__WEBPACK_IMPORTED_MODULE_1___default()('#consultation, #order').fadeOut();
		jquery__WEBPACK_IMPORTED_MODULE_1___default()('.overlay, #thanks').fadeIn('slow');

		jquery__WEBPACK_IMPORTED_MODULE_1___default()('form').trigger('reset');
	});
	return false;
});
